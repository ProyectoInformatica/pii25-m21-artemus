...
class DatabaseManager:
    ...
    def ensure_basic_data(cls):
        ...
        try:
            ...
            # 1. Roles
            cursor.executemany("INSERT IGNORE INTO Role (id_role, role) VALUES (%s, %s)", 
            ...
            # 3. Types
            types = [(1, 'Temperature'), (2, 'Humidity'), (3, 'Wind'), 
            ...
            cursor.execute(admin_sql, (
                '12345678X', 1, 'admin_soto', 'Adrian Soto', 
                'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 
                True, 'Central Ave 45', 'Madrid', '28001'
            ))
